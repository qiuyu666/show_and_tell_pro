...
tf.flags.DEFINE_string("input_file_pattern", "./data/train-?????-of-00256",
                       "File pattern of sharded TFRecord input files.")
tf.flags.DEFINE_string("inception_checkpoint_file", "./data/inception_v3/inception_v3.ckpt",
                       "Path to a pretrained inception_v3 model.")
tf.flags.DEFINE_string("train_dir", "./model/train",
...
if __name__ == "__main__":
    ...
    #INCEPTION_CHECKPOINT = "./data/inception_v3/inception_v3.ckpt"
    #MODEL_DIR = "./model"
