...
def process(image_save_path,description_save_path,image_name):
    ...
    data=pd.read_csv('/Users/lianqiuyu/Documents/test_for_yunying/zhonglaonian_girl_cloth.csv',header=-1)
    image_id=1
    data.columns=['image','shopid','description','title','tradeitemid','cid0','cid1','cid2']
...
process(image_save_path='/Users/lianqiuyu/Documents/test_for_yunying/zhonglaonian/',image_name='zhonglaonian_test',description_save_path='/Users/lianqiuyu/Documents/test_for_yunying/')