...
def process(image_save_path,description_save_path,image_name):
    ...
    data=pd.read_csv('/Users/lianqiuyu/Documents/uniq_comments_samples_v2.csv',skiprows=1,nrows=10000,header=-1)
    image_id=1
...
process(image_save_path='/Users/lianqiuyu/Documents/comment_test/images_1',image_name='comment_test',description_save_path='/Users/lianqiuyu/Documents/comment_test/')