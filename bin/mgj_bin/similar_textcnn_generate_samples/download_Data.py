...
def process(image_save_path,description_save_path,image_name):
    ...
    data=pd.read_csv('/home/qiuyu/similar_textcnn_generate_samples/similar_textcnn_samples.csv',
    nrows=20000,header=-1)
    image_id=1
...
#process(image_save_path='/Users/lianqiuyu/Documents/image_descriptio#n/val_data/',
#       image_name='mgj_val_',description_save_path='/Users/lianqiuyu#/Documents/image_description/')
process(image_save_path='/home/qiuyu/similar_textcnn_generate_samples/train_data/',image_name='similar_textcnn_train_',description_save_path='/home/qiuyu/similar_textcnn_generate_samples/')
