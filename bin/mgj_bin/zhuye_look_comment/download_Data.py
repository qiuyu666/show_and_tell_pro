...
def process(image_save_path,description_save_path,image_name):
    ...
    data=pd.read_csv('/home/qiuyu/zhuye_look_comment_data/qiuyu_get_zhuye_look_comments.csv',nrows=52000,header=-1)
    image_id=1
...
process(image_save_path='/home/qiuyu/zhuye_look_comment_data/train_data/',image_name='zhuye_look_comment_train_',description_save_path='/home/qiuyu/zhuye_look_comment_data/')
