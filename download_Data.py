...
def process(image_save_path,description_save_path,image_name):
    ...
    data=pd.read_csv('/home/qiuyu/get_imag_des.csv',
    nrows=33000,header=-1)
    image_id=1
...
process(image_save_path='/home/qiuyu/get_imag_des/train_data/',
        image_name='get_imag_des_train_',description_save_path='/home/qiuyu/get_imag_des/')
